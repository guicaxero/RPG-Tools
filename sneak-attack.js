let sneakAttack = async function() {
    ...
    if (existingEffect) {
        ...
        var the_message = `<em><strong>${target.name}</strong> Ataque normal.</em>`;
    } else {
            ...
            changes: [
                {
                    ...
                    value: "1d6", // Adiciona 1d6 de dano
                    priority: 20
                },
                {
        ...
        var the_message = `<em><strong>${target.name}</strong> Sneak Attack!</em>`;
    }
